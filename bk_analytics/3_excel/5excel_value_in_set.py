...
output_file = "bk_analytics/3_excel/output/5output.xls"
...
with open_workbook(input_file) as workbook:
    ...
    for row_index in range(1, worksheet.nrows):
        purchase_datetime = xldate_as_tuple(worksheet.cell_value(
            row_index, purchase_date_column_index), workbook.datemode)
