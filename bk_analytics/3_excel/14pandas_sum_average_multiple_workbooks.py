...
input_path = "bk_analytics/3_excel/input"
output_file = "bk_analytics/3_excel/output/14output.xls"
...
for workbook in all_workbooks:
    ...
    for worksheet_name, data in all_worksheets.items():
        ...
        worksheet_data_frames.append(pd.DataFrame(
            data, columns=['workbook', 'worksheet', 'worksheet_total', 'worksheet_average']))
