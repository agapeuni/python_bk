...
class Rock(Drawable):
    ...
    def __init__(self, pos, size):
        ...
        self.image = pygame.image.load("bk_pygame/games/asteroid/rock.png")
...
class Ship(Drawable):
    ...
    def __init__(self):
        ...
        self.accel = 0
        self.explode = False
        self.image = pygame.image.load("bk_pygame/games/asteroid/ship.png")
        self.bang = pygame.image.load("bk_pygame/games/asteroid/bang.png")
...
def main():
    ...
    score = 0
    back_x, back_y = 0, 0
    back_image = pygame.image.load("bk_pygame/games/asteroid/bg.png")
